...
export type SetValue = SetValueFunction
...
interface CustomButtonProps {
	...
	className?: string;
	// Define other button-related properties here
}

export interface ClearButtonProps extends Omit<CustomButtonProps, 'onClick'> {}
